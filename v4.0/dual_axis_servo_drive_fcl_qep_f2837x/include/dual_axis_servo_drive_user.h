...
#define M1_POSITION_FEEDBACK            POSITION_FEEDBACK_QEP
#define M2_POSITION_FEEDBACK            POSITION_FEEDBACK_QEP
...
#define M1_STARTUP_IQ_REF         0.04
#define M1_STARTUP_IQ_MIN_SCALE   0.10
