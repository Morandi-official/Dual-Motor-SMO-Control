...
typedef struct _ESMO_CompareLog_t_
{
    ...
    int16_t vqOut_q15;
    int16_t vsSq_q15;
    int16_t kslideHalf_q15;     // eSMO Kslide * 0.5 (Kslide = value * 2)
    int16_t eqMag_q15;
    int16_t thetaErr_q15;
} ESMO_CompareLog_t;
                                  ...
                                  uint16_t motorNum)
{
    ...
    esmoCompareLog[esmoCompareLogIndex].vsSq_q15 =
            q15Log(vsSq);
    esmoCompareLog[esmoCompareLogIndex].kslideHalf_q15 =
            q15Log(((pEsmo != (ESMO_Obj *)0) ? pEsmo->Kslide : 0.0f) * 0.5f);
