 ...
 */                                                                            \
    ...
    svgen2.tmp1  =  ((-svgen2.tmp2) / 2) +                                     \
                             pMotor->FCL_params.carrierMid;                    \
                                                                               \
    pMotor->esmoVabc_pu[0] = svgen2.Tc * pMotor->esmoPwmScale;                 \
    pMotor->esmoVabc_pu[1] = svgen2.Ualpha * pMotor->esmoPwmScale;             \
    pMotor->esmoVabc_pu[2] = svgen2.Tb * pMotor->esmoPwmScale;                 \
                                                                               \
/*                                                                             \
* -----------------------------------------------------------------------------\
